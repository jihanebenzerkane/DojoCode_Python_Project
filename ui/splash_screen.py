...
# Palette Lofi pastel (inspirée de l'image Lofi Town)
SPLASH_BG    = "#D4D9A0"   # Vert olive pastel
SPLASH_TEXT  = "#5A5944"   # Texte olive foncé
SPLASH_BTN   = "#8B8670"   # Bouton gris-olive
SPLASH_BTN_H = "#A09B83"   # Hover
SPLASH_WHITE = "#FEFDF4"   # Blanc crème
