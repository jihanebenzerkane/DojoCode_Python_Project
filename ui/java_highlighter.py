...
class JavaHighlighter(QSyntaxHighlighter):
    ...
    def __init__(self, document):
        ...
        kw_fmt.setForeground(QColor("#005C8A"))  # Bleu profond classique
